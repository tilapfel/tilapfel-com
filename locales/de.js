export default {
  ...
  portfolio: [
    { slug: 'studium', date: 'Seit 2010', category: 'Ausbildung', location: 'Platzhalter', title: 'Studium & Ausbildung', short: 'Grundlegende Ausbildung, auf der die heutige Arbeit aufbaut.', full: 'Details zu Studiengang und Ausbildungsstationen folgen hier in Kürze.', approach: '(Platzhalter – wird ergänzt)' },
    { slug: 'dozent-aufbau', date: 'Seit 2019', category: 'Werdegang', location: 'Selbständig', title: 'Aufbau der Selbständigkeit als Dozent', short: 'Entwicklung einer eigenständigen Vortrags- und Lehrtätigkeit.', full: 'Seit mehreren Jahren baue ich eine selbständige Tätigkeit als Dozent und Referent auf – von ersten Einzelvorträgen bis zu regelmäßigen Lehraufträgen.', approach: 'Der Weg führte über ehrenamtliche Vorträge zu bezahlten Aufträgen bei Bildungseinrichtungen, Verbänden und Unternehmen.' },
    { slug: 'verbandsarbeit-tbv', date: 'Seit 2021', category: 'NGO-Engagement', location: 'Taubblinden-Verband', title: 'Vorstandsarbeit im Taubblinden-Verband', short: 'Interessenvertretung taubblinder Menschen auf Verbandsebene.', full: 'Als Vorstandsmitglied vertrete ich die Interessen taubblinder Menschen gegenüber Politik, Kostenträgern und Öffentlichkeit.', approach: 'Dazu gehören Positionspapiere, Gespräche mit Ministerien und die Begleitung von Gesetzesvorhaben zur Teilhabe.' },
    { slug: 'edbu-engagement', date: 'Seit 2022', category: 'NGO-Engagement', location: 'European Deafblind Union', title: 'Mitarbeit in der European Deafblind Union', short: 'Engagement für gemeinsame europäische Standards.', full: 'Mitarbeit in einer europäischen Arbeitsgruppe zu Standards und Empfehlungen für assistive Technologien für taubblinde Menschen.', approach: 'Die Arbeitsgruppe bringt Vertreter:innen aus mehreren europäischen Ländern zusammen, um gemeinsame Mindeststandards zu erarbeiten.' },
    { slug: 'digitalisierung-beratung', date: 'Seit 2023', category: 'Eigenes Projekt', location: 'Bundesweit', title: 'Barrierefreie Digitalisierung', short: 'Laufendes Beratungsprojekt für Behörden und Unternehmen.', full: 'Beratung für Behörden und Unternehmen zur Umsetzung barrierefreier Software und Websites – von der ersten Konzeption bis zum Screenreader-Test.', approach: 'Ich arbeite eng mit Entwicklungsteams zusammen und prüfe bestehende Anwendungen mit eigener Screenreader- und Braillezeilen-Praxis.' },
    { slug: 'programmieren-lernen', date: '2015–2018', category: 'Eigener Weg', location: 'Selbststudium', title: 'Programmieren als taubblinder Mensch', short: 'Aneignung von Softwareentwicklung trotz fehlender barrierefreier Lernwege.', full: 'Ich habe mir Programmierung weitgehend selbst beigebracht – mit Screenreader und Braillezeile, oft ohne barrierefreie Lernmaterialien.', approach: 'Dieser Weg prägt bis heute, wie ich Software für andere taubblinde Nutzer:innen gestalte.' }
  ],

  termine: [
    { slug: 'digitale-teilhabe-heute', date: '22. Juli 2026', category: 'Vortrag', title: 'Digitale Teilhabe heute', location: 'Fachtagung Inklusion, Berlin', detail: 'Ein Vortrag über den aktuellen Stand digitaler Teilhabe in Deutschland, mit Fokus auf öffentliche Verwaltung und Bildungseinrichtungen.', info: 'Zielgruppe: Fachpublikum aus Verwaltung und Bildung. Dauer: 45 Minuten inkl. Fragerunde.' },
    { slug: 'vorstandssitzung-august', date: '5. August 2026', category: 'Vorstand', title: 'Vorstandssitzung Taubblinden-Verband', location: 'Verbandsbüro, Köln', detail: 'Reguläre Vorstandssitzung zu laufenden Anträgen, Haushalt und anstehenden Veranstaltungen des Verbands.', info: 'Verbandsintern – Teilnahme nach Absprache mit der Geschäftsstelle.' },
    { slug: 'barrierefreie-software-workshop', date: '14. September 2026', category: 'Workshop', title: 'Barrierefreie Software gestalten', location: 'Online', detail: 'Praxisworkshop für Entwicklungsteams: gemeinsames Testen eigener Anwendungen mit Screenreader und Braillezeile.', info: 'Zielgruppe: Entwickler:innen und Produktteams. Dauer: 3 Stunden, max. 15 Teilnehmende.' },
    { slug: 'taubblind-leben-wien', date: '2. Oktober 2026', category: 'Vortrag', title: 'Taubblind leben – Erfahrungsbericht', location: 'Universität Wien', detail: 'Persönlicher Erfahrungsbericht über Alltag, Kommunikation und Selbstbestimmung als taubblinder Mensch.', info: 'Zielgruppe: Studierende und Öffentlichkeit. Dauer: 60 Minuten.' },
    { slug: 'edbu-treffen-bruessel', date: '20. Oktober 2026', category: 'International', title: 'EDBU Arbeitsgruppentreffen', location: 'Brüssel', detail: 'Zweitägiges Treffen der europäischen Arbeitsgruppe Technologie zur Abstimmung gemeinsamer Standards.', info: 'Teilnahme auf Einladung der European Deafblind Union.' },
    { slug: 'screenreader-testing-hamburg', date: '11. November 2026', category: 'Workshop', title: 'Screenreader-Testing für Entwicklerteams', location: 'Hamburg', detail: 'Hands-on-Workshop zum systematischen Testen von Web- und App-Oberflächen mit gängigen Screenreadern.', info: 'Zielgruppe: QA und Entwicklung. Dauer: ganztägig.' }
  ],
  ...
  werte: ['Softwareentwicklung (Programmieren)', 'Pflanzlich kochen (Vegan)', 'Psychische Gesundheit (Psychologie)', 'Naturaktivitäten (Natursport)', 'Menschenrechte (Gerechtigkeit)'],

  principles: ['Barrierefreiheit ist kein Extra, sondern die Grundlage.', 'Teilhabe entsteht durch Zugang, nicht durch Rücksicht.', 'Ich zeige, was mit den richtigen Werkzeugen möglich ist.'],
